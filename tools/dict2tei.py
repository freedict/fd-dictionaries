...
def d2x_getInput():
	...
	groupDocT.add_option("-s", "--dtdsys", type="string", action="store", dest="DTDsys",default='http://www.tei-c.org/P4X/DTD/tei2.dtd' , help="set System DTD  to PATH.  NB: If your not using an XML/SGML catalog system you should set this to: /your/path/to/tei2.dtd" )
	groupDocT.add_option("-p", "--dtdpub", type="string",action="store", dest="DTDpub",default='-//TEI Consortium//DTD TEI P4//EN', help="set public DTD to \"Formal Public Identifier\"  NB: You _will_ need to quote it" )
