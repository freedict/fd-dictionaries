...
<h2><?php printf(_('Horst Eyermann, Michael Bunk and %1$smany more%2$s'),
 '<a target="_top" href="https://github.com/orgs/freedict/people">',
 '</a>') ?></h2>
...
<p><a href="https://github.com/freedict" target="_parent">
<img src="<?php echo fdict_url('images/Octocat.jpg') ?>"
