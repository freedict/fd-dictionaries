...
$Heading2= "<a href=\"http://www.freedict.de/\">The FreeDict Project</a>: Online&nbsp;Dictionary&nbsp;Query";
...
#	}
	...
	if (/^From/) {
	    ...
	    s,(\s){([^}\s][^}]*)(\n)$,$1.'<a href="'.$ReturnUrl.'?Form='.$Pgm.'2&Database=*&Query='.&xl($2).'">'.$2.$3,se;
	    s,^([^}]*)},$1.'</a>',e;
            print;
	}
    }
...
# $Header: /home/pyndap/cvsbackup/website/cgi-bin/Dict.cgi,v 1.1.1.1 2000-05-01 04:35:57 horst Exp $ #
